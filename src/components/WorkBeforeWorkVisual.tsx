...
const BODY_SEGMENTS: ScrollWordSegment[] = [
  ...
  ". Each one is documented to the standard an investor, funder, or developer can build from. By the time a problem reaches the Library, it has already survived the field. The work of naming it, testing it, and writing it up ",
