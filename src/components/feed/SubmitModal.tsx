 ...
 * the onClose prop. No URL routing involved.
 */
export function SubmitModal({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[70] flex items-stretch md:items-center justify-center px-0 md:px-6 py-0 md:py-10"
    >
      <button
        type="button"
        aria-label="Close"
        onClick={onClose}
        className="absolute inset-0 bg-foreground/45 backdrop-blur-sm cursor-default"
      />
